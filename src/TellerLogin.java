...
public class TellerLogin extends JFrame {
    ...
    private void initializeUI() {
        ...
        userIDField = createTextField("Teller ID");
    ...
    private void verifyCredentials(String userID, String userEmailID) {
        String query = "SELECT EmployeeID FROM EMPLOYEE WHERE EmployeeID = ? AND EmpEmailID = ?";
        ...
        try (Connection conn = DatabaseHelper.getConnection();
            ...
            if (rs.next()) {
                ...
                TellerHome AdminHome = new TellerHome();
                AdminHome.setVisible(true);
                TellerLogin.this.dispose(); // Close the login window
            } else {
                JOptionPane.showMessageDialog(TellerLogin.this, "Invalid credentials.");
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(TellerLogin.this, "Database error: " + ex.getMessage());
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            TellerLogin frame = new TellerLogin();
